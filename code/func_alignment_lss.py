...
# I/O
sub, roi = str(sys.argv[1]), str(sys.argv[2])
all_data = []
target_run, train_run = 1, 7
sub_list = ["01", "02", "03", "04", "06", "10", "14", "15", "16", "17", "18", "19", "20"]
event_file = f"/home/data/study_gaze_tracks/code/reference_face-tracks/studyf_run-0{target_run}_face-orientation.csv"
deriv_dir = "/home/data/study_gaze_tracks/scratch/study_face_tracks"
lut_df = pd.read_csv("/home/data/study_gaze_tracks/studyforrest-data-phase2/derivatives/fmriprep_mni/desc-aparcaseg_dseg.tsv", sep="\t")
...
conf_file = f"/home/data/study_gaze_tracks/studyforrest-data-phase2/derivatives/fmriprep_mni/sub-{sub}/ses-movie/func/sub-{sub}_ses-movie_task-movie_run-{target_run}_desc-confounds_timeseries.tsv"
confounds = pd.read_csv(conf_file, sep="\t")[conf_keep_list]

json_file = f"/home/data/study_gaze_tracks/studyforrest-data-phase2/derivatives/fmriprep_mni/sub-{sub}/ses-movie/func/sub-{sub}_ses-movie_task-movie_run-{target_run}_space-MNI152NLin2009cAsym_res-2_desc-preproc_bold.json"
...
for i, row in events.iterrows():
    ...
    smoothed = aligned_sub_hyperalignment["transformed"].smooth(fwhm=0)
